...
export default {
    ...
    async refreshContent() {
        const response = await axios.get(`/schedule/boarding/${this.username}?trainName=${this.trainName}&departureStation=${this.departureStation}&departureTime=${this.departureTime}&classCode=${this.classCode}&page=${this.page}`)
